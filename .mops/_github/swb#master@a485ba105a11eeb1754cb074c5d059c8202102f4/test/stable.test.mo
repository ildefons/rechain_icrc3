import SWB "../src/Stable";
import Iter "mo:base/Iter";

do {
  let mem = SWB.SlidingWindowBufferNewMem<Text>();
  let buf = SWB.SlidingWindowBuffer<Text>(mem);
...
do {
  let mem = SWB.SlidingWindowBufferNewMem<Nat>();
  let buf = SWB.SlidingWindowBuffer<Nat>(mem);
